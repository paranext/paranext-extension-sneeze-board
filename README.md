...
WARNING: This extension is entirely AI-generated based on [`SneezeBoardClient`](https://github.com/FoolRunning/SneezeBoard) with essentially zero code oversight. There may be lots of less-than-best practices and examples you do not want to follow.
